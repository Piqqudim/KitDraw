...
using gl::GL_BUFFER_CLIENT_POINTER_SIZE_MESA;
...
using gl::GL_CLIENT_POINTER_DYNAMIC_COPY_MESA;
using gl::GL_CLIENT_POINTER_DYNAMIC_DRAW_MESA;
using gl::GL_CLIENT_POINTER_DYNAMIC_READ_MESA;
using gl::GL_CLIENT_POINTER_RELEASE_ALL_MESA;
using gl::GL_CLIENT_POINTER_STATIC_COPY_MESA;
using gl::GL_CLIENT_POINTER_STATIC_DRAW_MESA;
using gl::GL_CLIENT_POINTER_STATIC_READ_MESA;
using gl::GL_CLIENT_POINTER_STREAM_COPY_MESA;
using gl::GL_CLIENT_POINTER_STREAM_DRAW_MESA;
using gl::GL_CLIENT_POINTER_STREAM_READ_MESA;
...
using gl::GL_FRAGMENT_SHADING_RATE_ATTACHMENT_WITH_DEFAULT_FRAMEBUFFER_SUPPORTED_EXT;
using gl::GL_FRAGMENT_SHADING_RATE_COMBINER_OP_KEEP_EXT;
using gl::GL_FRAGMENT_SHADING_RATE_COMBINER_OP_MAX_EXT;
using gl::GL_FRAGMENT_SHADING_RATE_COMBINER_OP_MIN_EXT;
using gl::GL_FRAGMENT_SHADING_RATE_COMBINER_OP_MUL_EXT;
using gl::GL_FRAGMENT_SHADING_RATE_COMBINER_OP_REPLACE_EXT;
using gl::GL_FRAGMENT_SHADING_RATE_NON_TRIVIAL_COMBINERS_SUPPORTED_EXT;
using gl::GL_FRAGMENT_SHADING_RATE_PRIMITIVE_RATE_WITH_MULTI_VIEWPORT_SUPPORTED_EXT;
using gl::GL_FRAGMENT_SHADING_RATE_WITH_SAMPLE_MASK_SUPPORTED_EXT;
using gl::GL_FRAGMENT_SHADING_RATE_WITH_SHADER_DEPTH_STENCIL_WRITES_SUPPORTED_EXT;
...
using gl::GL_MAX_FRAGMENT_SHADING_RATE_ATTACHMENT_LAYERS_EXT;
using gl::GL_MAX_FRAGMENT_SHADING_RATE_ATTACHMENT_TEXEL_ASPECT_RATIO_EXT;
using gl::GL_MAX_FRAGMENT_SHADING_RATE_ATTACHMENT_TEXEL_HEIGHT_EXT;
using gl::GL_MAX_FRAGMENT_SHADING_RATE_ATTACHMENT_TEXEL_WIDTH_EXT;
...
using gl::GL_MIN_FRAGMENT_SHADING_RATE_ATTACHMENT_TEXEL_HEIGHT_EXT;
using gl::GL_MIN_FRAGMENT_SHADING_RATE_ATTACHMENT_TEXEL_WIDTH_EXT;
...
using gl::GL_SHADING_RATE_1X1_PIXELS_EXT;
using gl::GL_SHADING_RATE_1X2_PIXELS_EXT;
using gl::GL_SHADING_RATE_1X4_PIXELS_EXT;
using gl::GL_SHADING_RATE_2_INVOCATIONS_PER_PIXEL_NV;
using gl::GL_SHADING_RATE_2X1_PIXELS_EXT;
using gl::GL_SHADING_RATE_2X2_PIXELS_EXT;
using gl::GL_SHADING_RATE_2X4_PIXELS_EXT;
using gl::GL_SHADING_RATE_4_INVOCATIONS_PER_PIXEL_NV;
using gl::GL_SHADING_RATE_4X1_PIXELS_EXT;
using gl::GL_SHADING_RATE_4X2_PIXELS_EXT;
using gl::GL_SHADING_RATE_4X4_PIXELS_EXT;
using gl::GL_SHADING_RATE_8_INVOCATIONS_PER_PIXEL_NV;
using gl::GL_SHADING_RATE_ATTACHMENT_EXT;
using gl::GL_SHADING_RATE_EXT;
