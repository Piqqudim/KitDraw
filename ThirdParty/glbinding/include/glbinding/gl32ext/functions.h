...
using gl::glAddClientPointerRangeMESA;
...
using gl::glFramebufferShadingRateEXT;
...
using gl::glGetFragmentShadingRatesEXT;
...
using gl::glReleaseClientPointerRangeMESA;
...
using gl::glShadingRateCombinerOpsEXT;
using gl::glShadingRateEXT;
