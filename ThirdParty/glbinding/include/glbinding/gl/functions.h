...
GLBINDING_API void glAddClientPointerRangeMESA(void * addr, GLsizeiptr size);
...
GLBINDING_API void glFramebufferShadingRateEXT(GLenum target, GLenum attachment, GLuint texture, GLint baseLayer, GLsizei numLayers, GLsizei texelWidth, GLsizei texelHeight);
...
GLBINDING_API void glGetFragmentShadingRatesEXT(GLsizei samples, GLsizei maxCount, GLsizei * count, GLenum * shadingRates);
...
GLBINDING_API void* glReleaseClientPointerRangeMESA(GLbitfield flags, GLsizeiptr * size);
...
GLBINDING_API void glShadingRateCombinerOpsEXT(GLenum combinerOp0, GLenum combinerOp1);
GLBINDING_API void glShadingRateEXT(GLenum rate);
